...
test("all seven operational panels render their matching analytics section", async () => {
  const routes = [
    ["dashboard/page.tsx", "wf-studio"],
    ["vivir-en-fuengirola/page.tsx", "vivir"],
    ["conoce-fuengirola/page.tsx", "conoce"],
    ["samuel-coach/page.tsx", "samuel-coach"],
    ["vokabel-world/page.tsx", "vokabel-world"],
    ["superentrenador/pt/page.tsx", "superentrenador"],
    ["todoplastico/page.tsx", "todoplastico"],
  ];

  for (const [route, panelKey] of routes) {
