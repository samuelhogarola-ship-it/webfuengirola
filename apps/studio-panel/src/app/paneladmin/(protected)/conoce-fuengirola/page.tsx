  ...
  return (
    ...
    >
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {[
          ['Clientes', '/paneladmin/conoce-fuengirola/clientes', 'Altas, aprobacion, edicion y acceso al detalle de cada cliente.'],
          ['Suscripciones', '/paneladmin/conoce-fuengirola/suscripciones', 'Crear planes, editar renovaciones y controlar pagos recurrentes.'],
          ['Nuevo cliente', '/paneladmin/conoce-fuengirola/clientes?new=1', 'Alta manual desde el panel cuando el cliente no se registra solo.'],
