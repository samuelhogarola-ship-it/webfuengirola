...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      clients: {
        Row: { auth_user_id: string | null; company: string | null; created_at: string; email: string; id: string; name: string; phone: string | null; project: string; status: string; updated_at: string }
        Insert: { auth_user_id?: string | null; company?: string | null; created_at?: string; email: string; id?: string; name: string; phone?: string | null; project?: string; status?: string; updated_at?: string }
        Update: { auth_user_id?: string | null; company?: string | null; created_at?: string; email?: string; id?: string; name?: string; phone?: string | null; project?: string; status?: string; updated_at?: string }
        Relationships: []
      }
      invoices: {
      ...
      monthly_stat_reports: {
        Row: { created_at: string; delivery_claim_token: string | null; delivery_claimed_at: string | null; email_message_id: string | null; email_sent_at: string | null; email_to: string | null; generated_at: string; label: string; last_delivery_error: string | null; markdown: string; month_key: string; site_reports: Json; updated_at: string }
        Insert: { created_at?: string; delivery_claim_token?: string | null; delivery_claimed_at?: string | null; email_message_id?: string | null; email_sent_at?: string | null; email_to?: string | null; generated_at: string; label: string; last_delivery_error?: string | null; markdown: string; month_key: string; site_reports?: Json; updated_at?: string }
        Update: { created_at?: string; delivery_claim_token?: string | null; delivery_claimed_at?: string | null; email_message_id?: string | null; email_sent_at?: string | null; email_to?: string | null; generated_at?: string; label?: string; last_delivery_error?: string | null; markdown?: string; month_key?: string; site_reports?: Json; updated_at?: string }
        Relationships: []
      }
      notifications: {
      ...
      pending_items: {
        Row: { client_id: string; created_at: string; description: string | null; id: string; last_reminder_sent_at: string | null; next_reminder_at: string | null; received_at: string | null; reminder_claim_token: string | null; reminder_claimed_at: string | null; reminder_interval_days: number | null; requested_at: string; sort_order: number; status: string; title: string; updated_at: string }
        Insert: { client_id: string; created_at?: string; description?: string | null; id?: string; last_reminder_sent_at?: string | null; next_reminder_at?: string | null; received_at?: string | null; reminder_claim_token?: string | null; reminder_claimed_at?: string | null; reminder_interval_days?: number | null; requested_at?: string; sort_order?: number; status?: string; title: string; updated_at?: string }
        Update: { client_id?: string; created_at?: string; description?: string | null; id?: string; last_reminder_sent_at?: string | null; next_reminder_at?: string | null; received_at?: string | null; reminder_claim_token?: string | null; reminder_claimed_at?: string | null; reminder_interval_days?: number | null; requested_at?: string; sort_order?: number; status?: string; title?: string; updated_at?: string }
