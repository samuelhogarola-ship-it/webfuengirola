...
| `STAT_REPORT_EMAIL_TO`                 | Destinatario del informe mensual; si falta usa `RESEND_TO_EMAIL` o el email admin  |
| `STAT_REPORT_STORAGE_DIR`              | Carpeta donde guardar `.md`; por defecto `storage/stat-reports`                    |
