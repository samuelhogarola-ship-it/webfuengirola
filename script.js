...
(function () {
  ...
  var translations = {
    es: {
      ...
      ogDescription: 'Páginas web para negocios locales en Fuengirola: Página Web Lite, landing pages, webs corporativas y automatización con estructura clara y enfoque SEO.',
      navHome: 'Inicio',
      ...
      heroTitle: 'Webs sobrias y bien pensadas para negocios locales.',
      heroSubtitle: 'Diseño claro, mensaje directo y una base profesional para captar mejor sin complicarlo todo.',
      ...
      trustHeadline: 'Menos ruido.<br>Más claridad para tu negocio.',
      ...
      servicesTitle: 'Servicios claros para crecer sin sobredimensionar el proyecto',
      servicePopular: 'Más popular',
      vatLabel: '+ IVA',
      serviceLiteEyebrow: 'Entrada rápida',
      serviceLiteTitle: 'Página Web Lite',
      serviceLiteDesc: 'Una página sencilla para tener escaparate online cuanto antes. Pensada para negocios que ya tienen su clientela y solo necesitan estar bien visibles.',
      ...
      serviceLiteFeature4: 'Menos trabajo SEO y menos conversión que la Landing',
      ...
      portfolioSub: 'Una selección breve para enseñar criterio, claridad y rango.',
      ...
      processTitle: 'Un proceso claro, rápido y sin vueltas',
      ...
      ctaTitle: 'Si tu negocio necesita una web seria,<br>lo hablamos claro.',
    ...
    en: {
      ...
      heroTitle: 'Quiet, well-crafted websites for local businesses.',
      heroSubtitle: 'Clear design, direct messaging and a professional base to attract better clients without overcomplicating things.',
      ...
      trustHeadline: 'Less noise.<br>More clarity for your business.',
      trust1Title: 'Clarity',
      ...
      servicesTitle: 'Clear services to grow without overbuilding the project',
      servicePopular: 'Most popular',
      vatLabel: '+ VAT',
      serviceLiteEyebrow: 'Quick start',
      serviceLiteTitle: 'Lite Website',
      serviceLiteDesc: 'A simple one-page site to get your business online fast. Made for businesses that already have clients and mainly need a clean online shop window.',
      ...
      portfolioSub: 'A short selection that shows judgement, clarity and range.',
      ...
      processTitle: 'A clear, fast process with no unnecessary friction',
      ...
      ctaTitle: 'If your business needs a serious website,<br>we can talk clearly about it.',
    ...
    de: {
      ...
      heroTitle: 'Ruhige, durchdachte Webseiten für lokale Unternehmen.',
      heroSubtitle: 'Klares Design, direkte Botschaft und eine professionelle Basis, um besser zu überzeugen, ohne alles zu verkomplizieren.',
      heroPrice: 'Festpreis',
      ...
      trustHeadline: 'Weniger Lärm.<br>Mehr Klarheit für Ihr Unternehmen.',
      ...
      servicesTitle: 'Klare Leistungen für Wachstum ohne unnötige Komplexität',
      servicePopular: 'Am beliebtesten',
      vatLabel: '+ MwSt.',
      serviceLiteEyebrow: 'Schneller Einstieg',
      serviceLiteTitle: 'Lite-Webseite',
      serviceLiteDesc: 'Eine einfache Ein-Seiten-Webseite als digitales Schaufenster. Für Unternehmen mit bestehendem Kundenstamm, die einfach sauber online sichtbar sein wollen.',
      ...
      serviceLiteFeature4: 'Weniger SEO- und Conversion-Arbeit als bei der Landing',
      ...
      portfolioSub: 'Eine kurze Auswahl, die Anspruch, Klarheit und Bandbreite zeigt.',
      ...
      processTitle: 'Ein klarer, schneller Ablauf ohne Umwege',
      ...
      ctaTitle: 'Wenn Ihr Unternehmen eine seriöse Webseite braucht,<br>sprechen wir klar darüber.',
      ...
      heroTitle: 'Rauhalliset ja harkitut verkkosivut paikallisille yrityksille.',
      heroSubtitle: 'Selkeä design, suora viesti ja ammattimainen perusta, joka auttaa vakuuttamaan paremmin ilman turhaa monimutkaisuutta.',
      ...
      trustHeadline: 'Vähemmän hälyä.<br>Enemmän selkeyttä yrityksellesi.',
      trust1Title: 'Selkeys',
      ...
      servicesTitle: 'Selkeät palvelut kasvuun ilman turhaa ylikomplisointia',
      servicePopular: 'Suosituin',
      vatLabel: '+ ALV',
      serviceLiteEyebrow: 'Nopea aloitus',
      serviceLiteTitle: 'Lite-verkkosivu',
      serviceLiteDesc: 'Yksinkertainen yhden sivun verkkosivu nopeaksi digitaaliseksi näyteikkunaksi. Sopii yrityksille, joilla on jo asiakkaita ja jotka haluavat vain näkyä siististi verkossa.',
      ...
      portfolioSub: 'Lyhyt valikoima, joka näyttää harkinnan, selkeyden ja laajuuden.',
      ...
      processTitle: 'Selkeä ja nopea prosessi ilman turhaa kitkaa',
      ...
      ctaTitle: 'Jos yrityksesi tarvitsee vakavasti otettavat verkkosivut,<br>puhutaan siitä selkeästi.',
