  ...
  function initWhatsappFabTheme() {
    ...
    function updateFabTheme() {
      ...
      var isOnDark = darkSections.some(function (section) {
        ...
        return (
          sectionRect.top <= fabCenterY && sectionRect.bottom >= fabCenterY
        );
      });
