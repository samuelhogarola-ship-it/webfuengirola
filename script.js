...
(function () {
  ...
  var translations = {
    es: {
      title: 'Web Fuengirola · Páginas web para comercios locales en 48h',
      metaDescription: 'Creamos páginas web sencillas, claras y profesionales para pequeños negocios locales en Fuengirola y la Costa del Sol. Desde 300€ + IVA. Dominio y hosting incluidos el primer año.',
      ogTitle: 'Web Fuengirola · Páginas web para comercios locales en 48h',
      ogDescription: 'Creamos webs sencillas, claras y profesionales para que tus clientes entiendan qué haces, dónde estás y cómo contactar contigo. Desde 300€ + IVA.',
      navHome: 'Inicio',
      ...
      heroTitle: 'Páginas web para comercios locales en 48h',
      ...
      portfolio3Title: 'Entrenador Personal Fuengirola',
      portfolio3Desc: 'Sitio minimalista enfocado en captación. Fotos del entrenador, metodología y contacto directo.',
      portfolio4Title: 'Tu Proyecto Local',
      portfolio4Desc: 'Esta tarjeta es editable. Añade aquí tu próximo proyecto local cuando esté publicado.',
    ...
    en: {
      ...
      portfolio4Title: 'Your Local Project',
      portfolio4Desc: 'This card is editable. Add your next local project here when it is published.',
    ...
    de: {
      ...
      portfolio4Title: 'Ihr lokales Projekt',
      portfolio4Desc: 'Diese Karte ist bearbeitbar. Fügen Sie hier Ihr nächstes lokales Projekt hinzu, sobald es veröffentlicht ist.',
      ...
      portfolio4Title: 'Oma paikallinen projektisi',
      portfolio4Desc: 'Tämä kortti on muokattava. Lisää tähän seuraava paikallinen projektisi, kun se on julkaistu.',
